...
select listings.property_type, count(reviews.id), max(reviews.date_reviewed) from listings inner join reviews
 on listings.id = reviews.listing_id group by listings.property_type;